...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      suffixIcon: GestureDetector(
                        onTap: () => setState(() => _currentObscure = !_currentObscure),
                        child: Icon(
                    ...
                    AppText(
                      ...
                      style: AppTextStyles.sm14Regular.copyWith(color: Colors.grey),
                    ),
  ...
  Widget _buildLabel(String text) {
    return Padding(
      ...
      child: AppText(
        text,
        style: AppTextStyles.base16SemiBold.copyWith(color: AppColors.textPrimary, fontSize: 15.sp),
      ),
    );
  }
      ...
      children: List.generate(4, (index) {
        return Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: index == 0 ? AppColors.actionPrimary : Colors.grey.shade200,
