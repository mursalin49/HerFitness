...
class BookingDateTime extends StatelessWidget {
  ...
  Widget _buildTimeSlots() {
    return Obx(() {
      final selectedSlotIndex = controller.selectedSlotIndex.value;
      ...
      return GridView.builder(
        ...
        itemBuilder: (_, index) {
          final time = controller.availableSlots[index];
          ...
          return GestureDetector(
            ...
            child: Container(
              alignment: Alignment.center,
              decoration: BoxDecoration(
                color: isSelected ? Colors.black : AppColors.bgTertiary,
